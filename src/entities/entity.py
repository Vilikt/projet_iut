...
class Entity(Sprite, GameLoopInterface):
    def __init__(self, name: str, pos_x: int = 0, pos_y: int = 0, image: Surface = None, collision_box: Rect = None, level: "Level" = None):
        super().__init__()
        ...
        self.__current_state: EntityState | None = None
